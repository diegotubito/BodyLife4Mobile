//
//  FirebaseManagerExtension.swift
//  Production
//
...
extension FirebaseManager {
    class FirebaseDatabase {
        ...
        func fetchWithQueryInterval<T:Decodable>(path: String, keyName: String, fromValue: Any, toValue: Any, completion: @escaping (T?) -> Void, err: @escaping (Error?) -> Void) {
            ...
            let query = ref.child("users")
                .child("RwF8H8sSk6jl")
                .child("sells")
                .queryOrdered(byChild: "queryByMY")
                //.queryEqual(toValue: 4232434.265118957)
                .queryEqual(toValue: "02-2020")
        ...
        func fetchJSON(path: String, completion: @escaping ([String : Any]?) -> Void, err: @escaping (Error?) -> Void) {
